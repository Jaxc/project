...
xst -ifn xst.scr
move DMC_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DMC_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DMC_exdes.ucf DMC_exdes

echo 'Running map'
map -timing -pr b DMC_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DMC_exdes -w routed.ncd routed.vhd
cd ..

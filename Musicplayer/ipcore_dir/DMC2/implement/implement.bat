...
xst -ifn xst.scr
move DMC2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DMC2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DMC2_exdes.ucf DMC2_exdes

echo 'Running map'
map -timing -pr b DMC2_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DMC2_exdes -w routed.ncd routed.vhd
cd ..
